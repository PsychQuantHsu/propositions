# manuscript-code-sync-discipline Specification

## Purpose

TBD - created by archiving change 'port-math-tools-assets'. Update Purpose after archive.
...
code:
  ...
  - .spectra.yaml
  - CLAUDE.md
  - rules/code-and-manuscript-sync.md
